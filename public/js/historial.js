document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderHistorial(citas) {
    ...
    citas.forEach(cita => {
      ...
      // Determinar si mostrar acciones (solo para citas CONFIRMADAS o PENDIENTES)
      ...
      row.innerHTML = `
        ...
        <td>
          ${mostrarAcciones ? `
            <a href="index.php?page=agenda_especializacion" class="btn btn-outline-primary btn-sm">Reprogramar</a>
  ...
  // Recargar historial cada 30 segundos para actualizaciones en tiempo real
  setInterval(loadHistorial, 30000);
});